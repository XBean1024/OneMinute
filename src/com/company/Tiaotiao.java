...
public class Tiaotiao {
    ...
    private static final String IMAGE_PATH = "/Users/binny/Downloads/screenshot.png";
    private static final String IMAGE_OUT_PATH = "/Users/binny/Downloads/jump/screenshot_out";
    ...
    private static void swipeTime(long ms) {
        try {
            Runtime.getRuntime()
                    .exec("adb shell input tap 1367 469 367 469 800 ");
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    private static void getScreenshot() {
        try {
            ...
            // 上传手机截图到电脑
            Runtime.getRuntime()
                    .exec("adb pull /sdcard/screenshot.png /Users/binny/Downloads/screenshot.png");
            Thread.sleep(1000);
